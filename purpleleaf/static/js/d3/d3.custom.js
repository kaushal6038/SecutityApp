$(document).ready(function() {
  ...
  function ShowRiskHistoricalData(){
        $.ajax({
            type: "GET",
            async: false,
            url: "/api/charts/dashboard_history",
          success: function(response) {
            riskhistorical_response = response.riskdatalist;
            historical_response = response.datalist;
            date = riskhistorical_response.date;
            critical_risk = riskhistorical_response.critical_risk;
            high_risk = riskhistorical_response.high_risk;
            medium_risk = riskhistorical_response.medium_risk;
            low_risk = riskhistorical_response.low_risk;
            vul = riskhistorical_response.vul;
            app_vul = riskhistorical_response.app_vul;
            active_ips_list = historical_response.active_ips;
            open_ports_list = historical_response.open_ports;
          }
        });
    }
  ShowRiskHistoricalData();

  $(function() {
    $("#active_ips").sparkline(active_ips_list, {
      type: 'line',
      lineColor: '#BF7A6A',
      fillColor: '#2A3039',
      lineWidth: 2,
  ...
  $(function() {
    $("#open_ports").sparkline(open_ports_list, {
      type: 'line',
      lineColor: '#D2A968',
      fillColor: '#2A3039',
      lineWidth: 2,
...
window.addEventListener("resize", drawVulnerabilitiesChart);
});
